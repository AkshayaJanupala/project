...
//	}
	...
	void testAddBooking() {
		...
		ResponseEntity<Booking> response = bookingController.addBooking(bookingDTO);
	...
	void testUpdateBooking() throws BookingNotFoundException {
		...
		// Call the controller method
		ResponseEntity<Booking> response = bookingController.updateBooking(1, bookingDTO);
	...
	@Test
	void testUpdateBooking_NotFound() throws BookingNotFoundException {
		// Mock the service method
	...
	@Test
	void testViewBooking() throws BookingNotFoundException {
		// Mock the service method
		when(bookingService.viewBooking(anyInt())).thenReturn(booking);

		// Call the controller method
		ResponseEntity<Booking> response = bookingController.viewBooking(1);
	...
	@Test
	void testViewAllBookingsByVehicle() throws VehicleNotFoundException {
		// Mock the service method
		when(bookingService.viewAllBookingsByVehicle(anyInt())).thenReturn(List.of(booking));

		// Call the controller method
		ResponseEntity<List<Booking>> response = bookingController.viewAllBookingsByVehicle(1);
	...
	@Test
	void testViewAllBookingsByVehicle_NotFound() throws VehicleNotFoundException {
		// Mock the service method
		when(bookingService.viewAllBookingsByVehicle(anyInt()))
				.thenThrow(new VehicleNotFoundException("No bookings found for vehicle"));
...
//	@Test
//	void testViewAllBookingsByDate() throws BookingDateNotFoundException {
//		// Mock the service method
//		when(bookingService.viewAllBookingsByDate(any(LocalDate.class))).thenReturn(List.of(booking));
//
//		// Call the controller method
//		ResponseEntity<List<Booking>> response = bookingController.viewAllBookingsByDate("2025-03-26");
//
//		// Assertions
//		assertEquals(HttpStatus.OK, response.getStatusCode());
//		assertNotNull(response.getBody());
...
//	@Test
//	void testViewAllBookingsByDate_NotFound() throws BookingDateNotFoundException {
//		// Mock the service method
//		when(bookingService.viewAllBookingsByDate(any(LocalDate.class)))
//				.thenThrow(new BookingDateNotFoundException("No bookings found for date"));
//
//		// Call the controller method
//		ResponseEntity<List<Booking>> response = bookingController.viewAllBookingsByDate("2025-03-26");
//
...
//		// Mock the service method
//		when(bookingService.getUserById(anyLong())).thenThrow(new UserNotFoundException("User not found"));
//
//		// Call the controller method
//		ResponseEntity<UserDTO> response = bookingController.getUserById(1L);
//
...
//	@Test
//	void testGetVehicleById_NotFound() throws VehicleNotFoundException {
//		// Mock the service method
//		when(bookingService.getVehicleById(anyInt())).thenThrow(new VehicleNotFoundException("Vehicle not found"));
//
//		// Call the controller method
//		ResponseEntity<VehicleDTO> response = bookingController.getVehicleById(1);
//
